...
rotate image check 0
    ...
    Compare different image arg  ${result_files}/img_rotated_${rotation}.png  ${IMAGE_1}
...
rotate image save folder change
    ...
    ${files}  List Files In Directory  ${result_files}/rotation
    compare image  ${result_files}/img_rotated_${rotation}.png  ${result_files}/rotation/${files}[0]  save_folder=${result_files}/rotation
