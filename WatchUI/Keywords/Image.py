...
class Image(Basics):
    ...
    def create_compare_screen_without_areas(self, path1, path2, *args, save_folder: str, ssim: float, image_format: str):
        save_folder = self.check_dir(save_folder)
    ...
    def create_crop_image(self, path, x1, y1, x2, y2, save_folder, image_format):
    ...
    def create_rotate_image(self, path, screen_name: str, save_folder: str, rotate: int, image_format: str):
        save_folder = self.check_dir(save_folder)
        img_format = self.check_image_format(image_format)
        self.check_image_exists(path)
